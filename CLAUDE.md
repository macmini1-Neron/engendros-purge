...
- **Design reference:** `docs/design-principles.md` is the senior game-design north-star + feature checklist — read it before designing, reviewing, or scoping any gameplay feature (juice, horror pacing, systems-over-content, co-op, fair-brutal difficulty).
