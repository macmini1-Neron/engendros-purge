...
| Density / length | **~4–6 h Act 1, STALKER density**: 5 boss-gates + ~20 side POIs + 8 edge POIs + ~30 micro; N route ~4.3 km, S route ~2.9 km (shorter, deadlier), finale climb ~1.2 km. Quiet-spot fills (owner-marked): S19 sawmill «ЛЕСОПИЛКА» (−790,+460; fortification materials, log pond) and S20 «ПуСО» decontamination station + contaminated-vehicle yard (−370,−1040; vehicle-parts source, Rassokha-style dread) with a new perimeter service road КПП→Прорыв→ПуСО→kolkhoz |
