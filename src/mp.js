...
export class MP {
  ...
  notifyChipSkinChanged() {
    ...
    if (this.isHost) {
      ...
      try { this.net.send('hello', { name: this.name, skin: this.chosenSkin || 0, chipSkin: skin, loadout: this._myLoadoutKeys(), pid: this.game.meta.playerId }); } catch (e) {} // re-hello → host re-stores my chipSkin
    }
  }
  _remote(id) {
