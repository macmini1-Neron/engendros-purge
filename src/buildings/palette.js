...
export const BUILDING_PALETTE = {
  brickRed: {
    kind: 'tiled', tex: 'brick', tile: { w: 0.45, h: 0.30 }, canvas: 256,   // 6×4 courses @ 75 mm
    tones: { hi: '#a85a40', mid: '#8a4632', lo: '#6e3626', slot: '#542818', bright: '#c06e50' },
  },
  brickGrey: {
    kind: 'tiled', tex: 'brick', tile: { w: 0.45, h: 0.30 }, canvas: 256,
    tones: { hi: '#9a948c', mid: '#7e7870', lo: '#5f5a52', slot: '#46423c', bright: '#b2aca2' },
  },
  concretePanel: {
    kind: 'tiled', tex: 'panelGrid', tile: { w: 3.0, h: 2.8 }, canvas: 512, // one precast panel module
    tones: { hi: '#aaa9a0', mid: '#908f86', lo: '#6f6e66', slot: '#55544e', bright: '#c2c1b8' },
  },
  corrugatedTin: {
    kind: 'tiled', tex: 'corrugated', tile: { w: 1.0, h: 1.0 }, canvas: 256,
    tones: { hi: '#9fb0b6', mid: '#7e8f96', lo: '#5c6b72', slot: '#434f55', bright: '#bccdd3' },
  },
  plaster: {
    kind: 'tiled', tex: 'plaster', tile: { w: 2.0, h: 2.0 }, canvas: 256,
  ...
  glassPane: {
    kind: 'glass', opacity: 0.3, color: '#9fc6cf', emissive: '#1c2a2e',     // src/airfield.js glassPane recipe
    tones: { hi: '#bcd8de', mid: '#9fc6cf', lo: '#7da6af', slot: '#5d868f', bright: '#d8eef3' },
  },
  signage: {
    kind: 'sign', bg: '#1d2528', fg: '#e8e6dd',
