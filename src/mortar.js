...
export class Mortar {
  ...
  _detonate(shell) {
    ...
    if (this.game._demoBlast) this.game._demoBlast(p, BAL.HE_RADIUS, true);  // HE breach / fell / ignite (self-gated); _demoBlast moved weapons->game in the explode() centralization
